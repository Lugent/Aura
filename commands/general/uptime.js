...
module.exports = {
    ...
    async execute(client, message, args, prefix)
    {
		...
		embed.setAuthor("By " + client.users.cache.get(client.config.owner).tag, client.users.cache.get(client.config.owner).displayAvatarURL({ format: "png", dynamic: true, size: 256 }));
