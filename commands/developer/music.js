...
module.exports = {
    ...
    async execute(client, message, args, prefix)
    {
        ...
        const resource = voice.createAudioResource(
            fs.createReadStream(process.cwd() + "/D_DDTBL3_MOD.ogg"), // ytdl("https://www.youtube.com/watch?v=lqYQXIt4SpA", {filter: "audioonly"})
		...
		await voice.entersState(player, voice.AudioPlayerStatus.Idle, 2147483647);
		connection.destroy();
