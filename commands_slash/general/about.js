...
module.exports = {
    ...
    async execute(client, interaction)
    {
		...
		embed.setAuthor(client.functions.getTranslation(client, interaction.author, interaction.guild, "commands/general/about", "embed.author", [client.users.cache.get(process.env.OWNER_ID).tag]), client.users.cache.get(process.env.OWNER_ID).displayAvatarURL({ format: "png", dynamic: true, size: 256 }));
